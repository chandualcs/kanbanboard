 ...
 * LICENSE file in the root directory of this source tree.
 */
var f=reactExports,k=Symbol.for("react.element"),l=Symbol.for("react.fragment"),m$1=Object.prototype.hasOwnProperty,n$1=f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,p$2={key:!0,ref:!0,__self:!0,__source:!0};
function q$1(c,a,g){var b,d={},e=null,h=null;void 0!==g&&(e=""+g);void 0!==a.key&&(e=""+a.key);void 0!==a.ref&&(h=a.ref);for(b in a)m$1.call(a,b)&&!p$2.hasOwnProperty(b)&&(d[b]=a[b]);if(c&&c.defaultProps)for(b in a=c.defaultProps,a)void 0===d[b]&&(d[b]=a[b]);return {$$typeof:k,type:c,key:e,ref:h,props:d,_owner:n$1.current}}reactJsxRuntime_production_min.Fragment=l;reactJsxRuntime_production_min.jsx=q$1;reactJsxRuntime_production_min.jsxs=q$1;
...
var React = (
  // prettier-ignore
  // @ts-ignore
  "default" in ReactOriginal ? index : ReactOriginal
);
...
const apiSlice = createApi({
  ...
  endpoints: (builder) => ({
    getTicketsAndUsers: builder.query({
      query: () => "frontend-assignment"
    })
  })
});
const { useGetTicketsAndUsersQuery } = apiSlice;
...
const NavHeader = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "navbar", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "navbar-button", onClick: toggleCardVisibility, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/Display.svg", alt: "Menu Icon", className: "icon" }),
      "Display",
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/down.svg", alt: "Menu Icon", className: "icon" })
    ] }) }),
    isMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dropdown-card", ref: cardRef, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-options", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { style: { margin: 0 }, children: "Grouping" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-options", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { style: { margin: 0 }, children: "Ordering" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            value: sortBy,
...
const KanbanCard = ({ ticket, groupBy, userMap }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "kanban-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "grey" }, children: ticket.id }),
      groupBy !== "user" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `user-avatar ${userMap[ticket.userId]?.available ? "available" : "not-available"}`,
          style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-row", children: [
      groupBy !== "status" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { children: ticket.title })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-row", children: [
      groupBy !== "priority" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-footer", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
      ...
      ticket.tag.map((tag, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-footer", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tag-dot" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h6", { style: { margin: 0 }, children: tag }, index)
      ] }))
    ] })
  ] }, ticket.id);
};
...
const App = () => {
  ...
  const [groupBy, setGroupBy] = reactExports.useState("status");
  ...
  const groupTickets = (tickets2) => {
    let groupedTickets2 = {};
    groupedTickets2 = _.groupBy(tickets2, (ticket) => {
      switch (groupBy) {
        case "user":
    ...
    const allGroups2 = groupBy === "status" ? ["Backlog", "Todo", "In progress", "Done", "Cancelled"] : groupBy === "priority" ? ["No priority", "Urgent", "High", "Medium", "Low"] : groupBy === "user" ? _.sortBy(
      Object.keys(groupedTickets2),
      (userId) => _.get(userMap[userId], "name", "Unknown").toLowerCase()
    ) : Object.keys(groupedTickets2);
    _.forEach(allGroups2, (group) => {
      if (!groupedTickets2[group]) {
        groupedTickets2[group] = [];
      } else {
        groupedTickets2[group] = _.orderBy(
          groupedTickets2[group],
    ...
    return { groupedTickets: groupedTickets2, allGroups: allGroups2 };
  };
  const { groupedTickets, allGroups } = groupTickets(tickets);
  const getHeader = (icon, title, numberOfEntities) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group-title", children: [
        icon,
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: numberOfEntities })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group-actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/add.svg", className: "icon" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/3 dot menu.svg", className: "icon" })
      ] })
    ] });
  };
  const renderGroupHeader = (group) => {
    switch (groupBy) {
      case "status":
        return getHeader(
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: STATUS_ICONS[group], alt: group, className: "group-icon" }),
          group,
      ...
      case "user":
        ...
        const availabilityClass = userMap[group]?.available ? "available" : "not-available";
        return getHeader(
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
      ...
      default:
        return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: group });
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "kanban-board", children: allGroups.map((group) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "kanban-column", children: [
          renderGroupHeader(group),
          groupedTickets[group].length > 0 ? groupedTickets[group].map((ticket) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            KanbanCard,
            {
              ticket,
              groupBy,
          ...
          )) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No tickets available" })
        ] }, group)) })
      ]
    }
  );
